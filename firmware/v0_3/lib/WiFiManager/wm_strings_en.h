...
"<form action='/wifi'    method='get'><button>Configure Heater & WiFi</button></form><br/>\n", // MENU_WIFI
...
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>Erase Config</button></form>";
const char HTTP_UPDATEBTN[]        PROGMEM = "<br/><form action='/update' method='get'><button>Update Firmware</button></form>";
...
const char S_brand[]              PROGMEM = "AE Landy Heater v2.0";
